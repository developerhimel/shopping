        ...
        <div className="container mx-auto px-2.5 sm:px-0">
          <div className="flex flex-row justify-between items-center">
            ...
            <div className="flex-row justify-end items-center hidden xl:flex">
              <Link href="/login">
                <a className="flex flex-row justify-start items-center p-2 px-3">
              ...
              <Link href="/orders">
                <a className="flex flex-col justify-center items-center p-2 px-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <Link href="/cart">
                <a className="flex flex-col justify-center items-center p-2 px-3 pr-0">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-6 w-6"
                    fill="none"
