  ...
  return (
    <div className="">
      ...
      <div class="bg-white my-5">
        <div class="grid xl:grid-cols-7 grid-cols-1 md:grid-cols-4 justify-items-center md:justify-items-start xl:justify-items-center md:py-12 gap-y-8 xl:gap-y-0 gap-x-20 py-9 2xl:container 2xl:mx-auto xl:px-20 md:px-6 px-28">
